...
HIGH_VOL_PROFIT_TARGET = 1.35   # 150% of entry price for high volatility (1.5x for testing)
...
LOW_VOL_PROFIT_TARGET = 1.25    # 150% of entry price for low volatility (1.5x for testing)