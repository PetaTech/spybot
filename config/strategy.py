...
HIGH_VOL_PROFIT_TARGET = 2.35   # 235% of entry price for high volatility (1.5x for testing)
...
LOW_VOL_PROFIT_TARGET = 2.25    # 225% of entry price for low volatility (1.5x for testing)